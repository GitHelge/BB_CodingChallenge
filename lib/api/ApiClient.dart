...
class ApiClient {
  ...
  Future<List<Movie>> fetchMovieList({ int page = 0, String searchString }) async {
    try {
      Response response = await Dio().get("https://www.omdbapi.com/?s=$searchString&page=$page&apikey=$_apiKey");
